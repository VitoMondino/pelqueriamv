              ...
              <tbody>
                {turnos.map((t) => (
                  <tr key={t.id}>
                    ...
                    <td>
                      <span className={`badge ${ESTADO_BADGE[t.estado]}`}>{t.estado}</span>
                    </td>
                    <td>{t.es_fijo ? <span className="badge badge-purple">Fijo</span> : '—'}</td>
                    <td>
                      <div className="td-actions" style={{ flexWrap: 'wrap' }}>
                        {t.estado === 'pendiente' && (
                          <button className="btn btn-success btn-sm" onClick={() => cambiarEstado(t.id, 'realizado')}>✓ Realizado</button>
                        )}
                        {t.estado !== 'cancelado' && (
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <select className="form-select" name="idCliente" value={form.idCliente} onChange={handleChange} required>
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <input className="form-input" type="time" name="hora" value={form.hora} onChange={handleChange} required />
              </div>
            </div>
            <div className="form-row">
              <div className="form-group">
