...
export default function ServiciosPage() {
  ...
  const openEdit = (s) => {
    setForm({ nombreServicio: s.nombre_servicio, precio: s.precio, estado: s.estado })
    setEditId(s.id)
    setModal(true)
    setError('')
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        await axiosClient.put(`/servicios/${editId}`, payload)
      } else {
        await axiosClient.post('/servicios', payload)
      }
  ...
  const handleDelete = async (id, nombre) => {
    ...
    try {
      ...
      alert(err.response?.data?.error || 'No se puede eliminar (tiene turnos asociados)')
    }
  }
      ...
      <div className="card">
        {loading ? (
          ...
          <div className="empty">
            ...
            <div className="empty-text">No hay servicios registrados</div>
          </div>
        ) : (
                  ...
                  <tr key={s.id}>
                    ...
                    <td>
                      <div className="td-actions">
                        ...
                        <button className="btn btn-ghost btn-sm" onClick={() => toggleEstado(s)}>
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input className="form-input" name="nombreServicio" value={form.nombreServicio} onChange={handleChange} required placeholder="Ej: Corte de cabello" />
            </div>
            <div className="form-row">
              <div className="form-group">
                <label className="form-label">Precio *</label>
                <input className="form-input" type="number" name="precio" value={form.precio} onChange={handleChange} min="0" step="0.01" required placeholder="0.00" />
              </div>
              <div className="form-group">
